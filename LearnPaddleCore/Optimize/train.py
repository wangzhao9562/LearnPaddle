...
with fluid.dygraph.guard():
    ...
    # Momentum optimizer
    # optimizer = fluid.optimizer.MomentumOptimizer(learning_rate=0.01, parameter_list=model.parameters())
    # AdaGrad optimizer
    # optimizer = fluid.optimizer.AdagradOptimizer(learning_rate=0.01, parameter_list=model.parameters())
    # Adam optimizer
    # optimizer = fliud.optimizer.AdamOptimizer(learning_rate=0.01, parameter_list=model.parameters())
